...
comp_sol_folio: 'Folio',
  ...
  // REPORTES — UI
  rep_title:                  'Reportes',
  rep_subtitle:               'Genera y exporta reportes a Excel con formato profesional',
  rep_configure:              'Configurar reporte',
  rep_type:                   'Tipo de reporte',
  rep_type_financial:         'Reporte Financiero',
  rep_type_inventory:         'Reporte de Inventario',
  rep_type_general:           'Resumen General del Proyecto',
  rep_from:                   'Desde',
  rep_to:                     'Hasta',
  rep_generating:             'Generando...',
  rep_download_excel:         'Descargar Excel',
  rep_print_view:             'Imprimir vista',
  rep_error_generating:       'Error generando el reporte: {msg}',

  rep_total_budget:           'Presupuesto total',
  rep_real_cost_executed:     'Costo real ejecutado',
  rep_total_real_cost:        'Costo real total',
  rep_deviation:              'Desviación',
  rep_execution_pct:          '% Ejecución',
  rep_summary_by_category:    'Resumen por categoría',
  rep_category:               'Categoría',
  rep_real_cost:              'Costo real',
  rep_pct_of_total:           '% del total',
  rep_total:                  'TOTAL',
  rep_total_real:             'TOTAL REAL',
  rep_budget_vs_real:         'Presupuesto vs Real por actividad',
  rep_col_code:               'Código',
  rep_col_activity:           'Actividad',
  rep_col_budgeted:           'Presupuestado',
  rep_col_real:               'Real',
  rep_col_deviation_amt:      'Desviación $',
  rep_col_deviation_pct:      'Desv. %',
  rep_col_status:             'Estado',
  rep_status_ok:              '✓ OK',
  rep_status_alert:           '⚠ Alerta',
  rep_status_critical:        '⚠ Crítico',

  rep_inv_tab_stock:          'Stock actual',
  rep_inv_tab_entries:        'Entradas',
  rep_inv_tab_exits:          'Salidas',
  rep_inv_col_code:           'Código',
  rep_inv_col_desc:           'Descripción',
  rep_inv_col_unit:           'Unidad',
  rep_inv_col_location:       'Ubicación',
  rep_inv_col_stock:          'Stock actual',
  rep_inv_col_min:            'Stock mín.',
  rep_inv_col_status:         'Estado',
  rep_inv_col_date:           'Fecha',
  rep_inv_col_material:       'Material',
  rep_inv_col_qty:            'Cantidad',
  rep_inv_col_price:          'Precio unit.',
  rep_inv_col_total:          'Total',
  rep_inv_col_invoice:        'Factura',
  rep_inv_col_supplier:       'Proveedor',
  rep_inv_col_project:        'Proyecto',
  rep_inv_col_activity:       'Actividad',
  rep_inv_critical:           'Crítico',
  rep_inv_ok:                 'OK',

  rep_project_info:           'Información del proyecto',
  rep_proj_code:              'Código',
  rep_proj_client:            'Cliente',
  rep_proj_status:            'Estado',
  rep_proj_currency:          'Moneda',
  rep_proj_start:             'Inicio',
  rep_proj_end_est:           'Fin est.',
  rep_proj_city:              'Ciudad',
  rep_proj_country:           'País',
  rep_cost_summary:           'Resumen de costos',
  rep_amount:                 'Monto',
  rep_cat_materials_lbl:      'Materiales',
  rep_cat_contingencies_lbl:  'Imprevistos',
  rep_cat_payroll_lbl:        'Nómina / Planilla',
  rep_cat_subcontracts_lbl:   'Subcontratos',
  rep_cat_equipment_lbl:      'Equipos',
  rep_cat_administration_lbl: 'Administración',

  rep_payroll_section:        'Nómina / Planilla',
  rep_payroll_worker:         'Trabajador',
  rep_payroll_position:       'Cargo',
  rep_payroll_period:         'Período',
  rep_payroll_base:           'Base',
  rep_payroll_deductions:     'Deducciones',
  rep_payroll_net:            'Neto',

  rep_sub_section:            'Subcontratos',
  rep_sub_subcontractor:      'Subcontratista',
  rep_sub_description:        'Descripción',
  rep_sub_contract:           'Contrato',
  rep_sub_progress:           '% Avance',
  rep_sub_paid:               'Pagado',

  // STORE — mensajes de negocio
  store_material_code_exists: 'Error: El código de material ya existe.',
...
comp_requester_info: 'Requester information',
  ...
  // REPORTS — UI
  rep_title:                  'Reports',
  rep_subtitle:               'Generate and export professionally formatted Excel reports',
  rep_configure:              'Configure report',
  rep_type:                   'Report type',
  rep_type_financial:         'Financial Report',
  rep_type_inventory:         'Inventory Report',
  rep_type_general:           'General Project Summary',
  rep_from:                   'From',
  rep_to:                     'To',
  rep_generating:             'Generating...',
  rep_download_excel:         'Download Excel',
  rep_print_view:             'Print view',
  rep_error_generating:       'Error generating report: {msg}',

  rep_total_budget:           'Total budget',
  rep_real_cost_executed:     'Real cost executed',
  rep_total_real_cost:        'Total real cost',
  rep_deviation:              'Deviation',
  rep_execution_pct:          '% Execution',
  rep_summary_by_category:    'Summary by category',
  rep_category:               'Category',
  rep_real_cost:              'Real cost',
  rep_pct_of_total:           '% of total',
  rep_total:                  'TOTAL',
  rep_total_real:             'TOTAL REAL',
  rep_budget_vs_real:         'Budget vs Real by activity',
  rep_col_code:               'Code',
  rep_col_activity:           'Activity',
  rep_col_budgeted:           'Budgeted',
  rep_col_real:               'Real',
  rep_col_deviation_amt:      'Deviation $',
  rep_col_deviation_pct:      'Dev. %',
  rep_col_status:             'Status',
  rep_status_ok:              '✓ OK',
  rep_status_alert:           '⚠ Alert',
  rep_status_critical:        '⚠ Critical',

  rep_inv_tab_stock:          'Current stock',
  rep_inv_tab_entries:        'Entries',
  rep_inv_tab_exits:          'Exits',
  rep_inv_col_code:           'Code',
  rep_inv_col_desc:           'Description',
  rep_inv_col_unit:           'Unit',
  rep_inv_col_location:       'Location',
  rep_inv_col_stock:          'Current stock',
  rep_inv_col_min:            'Min. stock',
  rep_inv_col_status:         'Status',
  rep_inv_col_date:           'Date',
  rep_inv_col_material:       'Material',
  rep_inv_col_qty:            'Quantity',
  rep_inv_col_price:          'Unit price',
  rep_inv_col_total:          'Total',
  rep_inv_col_invoice:        'Invoice',
  rep_inv_col_supplier:       'Supplier',
  rep_inv_col_project:        'Project',
  rep_inv_col_activity:       'Activity',
  rep_inv_critical:           'Critical',
  rep_inv_ok:                 'OK',

  rep_project_info:           'Project information',
  rep_proj_code:              'Code',
  rep_proj_client:            'Client',
  rep_proj_status:            'Status',
  rep_proj_currency:          'Currency',
  rep_proj_start:             'Start',
  rep_proj_end_est:           'Est. end',
  rep_proj_city:              'City',
  rep_proj_country:           'Country',
  rep_cost_summary:           'Cost summary',
  rep_amount:                 'Amount',
  rep_cat_materials_lbl:      'Materials',
  rep_cat_contingencies_lbl:  'Contingencies',
  rep_cat_payroll_lbl:        'Payroll',
  rep_cat_subcontracts_lbl:   'Subcontracts',
  rep_cat_equipment_lbl:      'Equipment',
  rep_cat_administration_lbl: 'Administration',

  rep_payroll_section:        'Payroll',
  rep_payroll_worker:         'Worker',
  rep_payroll_position:       'Position',
  rep_payroll_period:         'Period',
  rep_payroll_base:           'Base',
  rep_payroll_deductions:     'Deductions',
  rep_payroll_net:            'Net',

  rep_sub_section:            'Subcontracts',
  rep_sub_subcontractor:      'Subcontractor',
  rep_sub_description:        'Description',
  rep_sub_contract:           'Contract',
  rep_sub_progress:           '% Progress',
  rep_sub_paid:               'Paid',

  // STORE — business messages
  store_material_code_exists: 'Error: Material code already exists.',
...
/* ============================================================
   STANDALONE — para código fuera del LangProvider (ej: store)
   ============================================================ */
export const getLang = () => (typeof localStorage !== 'undefined'
  ? (localStorage.getItem(LS_KEY) || 'ES')
  : 'ES')

export const tStatic = (key, vars = {}) => {
  const dict = getLang() === 'ES' ? ES : EN
  let text = dict[key] || key
